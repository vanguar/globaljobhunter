        ...
        <body>
            <div class="card">
                ...
                <div>
                    ...
                    <a href="mailto:tzvanguardia@gmail.com?subject=Вопрос по GlobalJobHunter" class="btn btn-secondary" data-i18n="📧 Связаться с нами">📧 Связаться с нами</a>
                </div>
                
                <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #dee2e6;">
                    <small style="color: #6c757d;">
                        <strong data-i18n='Передумали? Вы всегда можете подписаться снова на'>Передумали? Вы всегда можете подписаться снова на</strong> 
                        <a href="/" style="color: #007bff;" data-i18n="главной странице">главной странице</a>
                    </small>
                </div>
            </div>
        </body>
